    ...
    $.ajax({
      ...
      success: function(json) {
        ...
        $.getJSON('/cart.js', function(cart) {
          ...
          $('#cart > button .total-price').html(Shopify.formatMoney(cart.total_price));
          // $('#cart > button').html('<i class="ion-bag"></i><span id="cart-total">' + cart.item_count + '</span>');
        ...
        $('#cart > ul').load('/ #cart > ul li', function( response, status, xhr ) {
    ...
    $.ajax({
      ...
      success: function(json) {
        ...
        $.getJSON('/cart.js', function(cart) {
          setTimeout(function () {
            $('#cart > button #cart-total .txt_number').html(cart.item_count);
            $('#cart > button .total-price').html('<span class=money>'+Shopify.formatMoney(cart.total_price)+'</span>');
          }, 10);
        });
  ...
  'remove': function(key) {
    $.ajax({
      ...
      success: function(json) {
        ...
        setTimeout(function () {
          $('#cart > button #cart-total .txt_number').html(json['item_count']);
          $('#cart > button .total-price').html('<span class=money>'+Shopify.formatMoney(json['total_price'])+'</span>');
        }, 10);
